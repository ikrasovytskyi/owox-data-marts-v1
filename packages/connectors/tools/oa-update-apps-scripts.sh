...
folders=("Sources/BankOfCanada" "Sources/FacebookMarketing" "Sources/OpenExchangeRates" "Sources/TikTokAds" "Sources/LinkedInAds" "Sources/LinkedInPages" "Sources/MicrosoftAds" "Sources/XAds" "Sources/CriteoAds" "Templates/PublicEndPoint" "Templates/Token-Based")
